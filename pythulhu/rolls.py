...
def low_among(investigators, skill):
	return reduce(lambda x, y: x if attrget(x, "skills", skill, "value") < rget(
				attrget(y, "skills", skill, "value") else y, investigators)
